...
module.exports.run = async function({ api, event, Users }) {
  ...
  if (event.logMessageData.addedParticipants && Array.isArray(event.logMessageData.addedParticipants) && event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    let gifUrl = 'https://i.imgur.com/gnbembK.mp4';
...
https://www.facebook.com/profile.php?id=100062724886617&mibextid=ZbWKwL

🔵WHATSAPP NUMBER: wa.me/+8801608798663

🟢SUPPORT EMAIL: asifahmed7763@gmail.com`, attachment: fs.createReadStream(gifPath)}, threadID));
  }})
.catch(error => {
    console.error(error);
});
