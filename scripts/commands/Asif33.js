...
const media = (
	...
	if (body.indexOf("🫰")==0 || body.indexOf(" ")==0 || body.indexOf(" ")==0 || body.indexOf(" ")==0 || body.indexOf(" ")==0 || body.indexOf(" ")==0 || body.indexOf(" ")==0 || body.indexOf(" ")==0 || body.indexOf(" ")==0 || body.indexOf("family")==0) {
		var msg = {
				body: "প্রত্যেকটা/nমানুষই/nযে/nতার/nচোখের/nপানি/nদিয়ে/nকষ্টটাকে/nদেখাবে/nএমনটা/nনা/nকারো/nকারো/nহাসিঁ/nমধ্যে/nও/nভয়ংকর/nরকম/nকষ্ট/nথাকে/nসেটা/nকেউ/nবুজতেও/nপারে/nনা😅/nMD ASIF Ahmed Niloy",
				attachment: media
			}
